# Project 2: Motion Planning Analysis with OMPL

## Introduction

- In this project, we aim to finish three collision checking functions for point, round and square robots given robot’s x, y coordinate,
  orientation (for square one), side length (for square one) and rectangular obstacles’ coordinate. 
