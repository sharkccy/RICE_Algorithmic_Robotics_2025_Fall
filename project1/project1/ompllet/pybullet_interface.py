...
class PyBulletSimulator:
    ...
    def display_environment(self, start, goal):
        left = self.client.B3G_LEFT_ARROW
        right = self.client.B3G_RIGHT_ARROW
        space_code = ord(' ')

        print("Press left to see the start. Press right to see the goal. Press space to continue.")
        c = start
        ...
        while True:
            ...
            if left in keys and keys[left] & self.client.KEY_WAS_TRIGGERED:
                ...
                c = goal
            elif space_code in keys and keys[space_code] & self.client.KEY_WAS_TRIGGERED:
                break
