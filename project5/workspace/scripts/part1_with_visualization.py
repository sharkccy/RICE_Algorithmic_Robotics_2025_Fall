...
def main() -> None:
    ...
    start_joint = np.array([2.8, 0.0, 0.0, 0.0, 2.2, 2.2, -0.5], dtype=np.float64)   
    mid_joint   = np.array([2.8, 0.0, 0.0, 0.0, 2.2, 2.2, -0.4], dtype=np.float64)     
    mid2_joint  = np.array([2.8, 0.0, 0.0, 0.0, 2.2, 2.2, -0.5], dtype=np.float64) 
    goal_joint  = np.array([2.8, 0.0, 0.0, 0.0, 2.2, 2.2, -0.3], dtype=np.float64)     
